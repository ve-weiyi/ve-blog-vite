...
module.exports = {
	...
	rules: {
		...
		"space-before-blocks": [2, "always"], // 在块之前要求有空格
		// "space-before-function-paren": [2, "always"], // 在函数括号之前不允许有空格
		// "space-in-parens": [2, "always"], // 在括号内要求有空格
		"space-infix-ops": 2, // 在中缀操作符周围要求有空格
		"space-unary-ops": [
			2,
			{
				words: true,
