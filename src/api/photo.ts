...
import type { BatchResp, IdReq, IdsReq, PageQuery, PageResp, Photo } from "./types"
...
/** "删除照片" */
export function deletePhotoApi(data?: IdReq): Promise<IApiResponseData<BatchResp>> {
...
/** "批量删除照片" */
export function deletePhotoListApi(data?: IdsReq): Promise<IApiResponseData<BatchResp>> {
  return http.request<IApiResponseData<BatchResp>>({
