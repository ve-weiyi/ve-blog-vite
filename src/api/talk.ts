...
import type { BatchResp, EmptyResp, IdReq, IdsReq, PageQuery, PageResp, TalkDetails } from "./types"

/** "创建说说" */
export function createTalkApi(data?: TalkDetails): Promise<IApiResponseData<TalkDetails>> {
...
/** "更新说说" */
export function updateTalkApi(data?: TalkDetails): Promise<IApiResponseData<TalkDetails>> {
  return http.request<IApiResponseData<TalkDetails>>({
...
/** "删除说说" */
export function deleteTalkApi(data?: IdReq): Promise<IApiResponseData<BatchResp>> {
...
/** "批量删除说说" */
export function deleteTalkListApi(data?: IdsReq): Promise<IApiResponseData<BatchResp>> {
  return http.request<IApiResponseData<BatchResp>>({
