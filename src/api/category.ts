...
import type { BatchResp, Category, IdReq, IdsReq, PageQuery, PageResp } from "./types"
...
/** "删除文章分类" */
export function deleteCategoryApi(data?: IdReq): Promise<IApiResponseData<BatchResp>> {
...
/** "批量删除文章分类" */
export function deleteCategoryListApi(data?: IdsReq): Promise<IApiResponseData<BatchResp>> {
  return http.request<IApiResponseData<BatchResp>>({
...
/** "查询文章分类" */
export function findCategoryApi(data?: IdReq): Promise<IApiResponseData<Category>> {
  return http.request<IApiResponseData<Category>>({
