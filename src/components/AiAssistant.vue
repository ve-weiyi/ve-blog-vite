<template>
  <div>
    <!-- 聊天界面 -->
    <div
      class="assistant-container animated bounceInUp"
      v-show="isShow"
      @click="closeAll"
    ...
    >
      <!-- 标题 -->
      <div class="header">
        <img width="32" height="32" :src="avatar" alt="ai助手" />
        <div style="margin-left: 12px">
          <div>ai助手</div>
          <div style="font-size: 12px">您的智能ai助手</div>
        </div>
    ...
    <!-- 未读数量 -->
    <div class="assistant-btn" @click="open">
      <span class="unread" v-if="unreadCount > 0">{{ unreadCount }}</span>
      <div style="display: flex; justify-content: center; align-items: center; width: 100%; height: 100%">
        <img width="36" height="36" :src="image" alt="ai助手" />
      </div>
    </div>
  </div>
</template>
...
import image from "@/assets/images/chatgpt.png"
import avatar from "@/assets/images/chatgpticon.png"
// 获取存储的博客信息
